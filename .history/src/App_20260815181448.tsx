...
const hitos: Hito[] = [
  {
    ...
    descripcion: "Desde el derecho romano se concebían los recursos naturales como bienes comunes ('res communis'). A través de la Lex Aquilia se empezaron a regular jurídicamente las acciones civiles ante los daños ocasionados por dolo o culpa, marcando los antecedentes históricos fundamentales sobre cómo el derecho de propiedad y la responsabilidad debían responder ante los perjuicios causados injustamente.",
    icono: "🏛️",
    color: "#fca5a5",
    badgeBg: "#f97316",
  ...
  },
  {
    ...
    descripcion: "En los inicios de la república, Bolívar impulsó decretos clave enfocados en cuidar los bosques, regular las aguas y proteger los recursos de la nación. Fueron las primeras directrices oficiales para frenar la tala desmedida y cuidar las fuentes hídricas, sentando el punto de partida en nuestra historia legislativa para la gestión de los recursos naturales.",
    icono: "📜",
    color: "#e879f9",
    badgeBg: "#a855f7",
    fuente: "Kerguelén Durango, E. A. (2016). Antecedentes históricos del derecho ambiental colombiano."
  },
  {
    ...
    descripcion: "Representó un cambio clave donde el Estado toma el control directo y la organización técnica para el manejo, inspección y conservación de los recursos renovables en el país, unificando criterios y fortaleciendo la vigilancia institucional a nivel nacional.",
    icono: "🛡️",
    color: "#f87171",
    badgeBg: "#2563eb",
    fuente: "Kerguelén Durango, E. A. (2016). Antecedentes históricos del derecho ambiental colombiano."
  },
  {
    ...
    descripcion: "Un hito jurisprudencial muy importante porque permitió exigir responsabilidades e indemnizaciones por actividades peligrosas sin que fuera obligatorio demostrar la culpa directa, facilitando la protección y el resarcimiento frente a daños complejos.",
    icono: "⚖️",
    color: "#7dd3fc",
    badgeBg: "#dc2626",
  ...
  },
  {
    ...
    descripcion: "Este código dejó muy claro que cualquier contaminación o daño al entorno acarrea sanciones directas. Estableció con firmeza las bases de la responsabilidad civil y administrativa aplicable ante la afectación de los recursos naturales.",
    icono: "📘",
    color: "#86efac",
    badgeBg: "#eab308",
  ...
  },
  {
    ...
    descripcion: "Se le considera la piedra angular del derecho ambiental en Colombia al declarar el medio ambiente como un patrimonio común de todos. Dio facultades para expedir normas de control a la contaminación y estructurar la protección ecológica nacional.",
    icono: "🌿",
    color: "#fde047",
    badgeBg: "#15803d",
    fuente: "Flórez Hernández, C., et al. (2024). Hitos de la normatividad colombiana en materia de protección ambiental."
  },
  {
    ...
    descripcion: "Transformó la gestión ambiental del país creando el Ministerio del Ambiente y el SINA. Fortaleció el control regional mediante las corporaciones autónomas e introdujo herramientas económicas y multas severas para disuadir el impacto ambiental.",
    icono: "🏛️",
    color: "#fed7aa",
    badgeBg: "#ec4899",
  ...
  },
  {
    ...
    descripcion: "La Constitución de 1991 elevó el ambiente sano a rango de derecho colectivo fundamental e incorporó más de 49 artículos ambientales. Creó herramientas jurídicas poderosas como las acciones populares para prevenir, exigir restauración y resarcir daños.",
    icono: "🇨🇴",
    color: "#fbcfe8",
    badgeBg: "#78350f",
  ...
  },
  {
    ...
    descripcion: "Fijó el régimen sancionatorio actual permitiendo aplicar medidas preventivas inmediatas y multas de hasta 5,000 salarios mínimos, cierres y la obligación directa de restaurar el daño causado a los ecosistemas afectados.",
    icono: "⚠️",
    color: "#fca5a5",
    badgeBg: "#e11d48",
...
export default function App() {
  ...
  return (
    <div style={{
      ...
      {/* TÍTULO PRINCIPAL - Integrado al estilo natural sin contenedor pesado */}
      <div style={{
        maxWidth: '850px',
        ...
        <p style={{ fontSize: '11px', color: '#64748b', fontWeight: '700', maxWidth: '600px', margin: '0 auto' }}>
      ...
      <div style={{ maxWidth: '950px', margin: '0 auto', position: 'relative' }}>
        ...
        {/* Línea Central Estilizada con hojas decorativas */}
        <div style={{
          position: 'absolute',
          left: '50%',
          top: '20px',
