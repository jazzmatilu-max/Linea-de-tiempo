...
const hitos: Hito[] = [
  ...
  },
  {
    ...
    descripcion: "De conformidad con el Acto Constituyente No. 62 (1991), la Asamblea Nacional Constituyente consagró la denominada 'Constitución Ecológica' al integrar más de 49 disposiciones sobre medio ambiente, elevando el derecho a un ambiente sano a rango colectivo fundamental e instituyendo mecanismos procesales constitucionales de gran importancia como la Acción Popular (respaldada por la Ley 472), permitiendo exigir judicialmente la prevención y restauración de los daños al ecosistema."
  ...
  },
  {
    ...
    titulo: "REESTRUCTURACIÓN SINA",
    subtitulo: "Hito: Ley 99 de 1993, Ministerio de Ambiente e instrumentos económicos",
    descripcion: "Conforme a Valencia Hernández (2007), la Ley 99 de 1993 estructuró la institucionalidad moderna creando el Ministerio del Ambiente y el Sistema Nacional Ambiental (SINA). Descentralizó el control a través de las Corporaciones Autónomas Regionales e incorporó instrumentos económicos de gestión ambiental (tasas retributivas, compensatorias y multas) para desincentivar la contaminación y alinear la economía con el desarrollo sostenible.",
    contexto: "El SINA se conformó por organismos de control nacional y regional, incluyendo INDERENA, CORNARE, CAR y otras corporaciones regionales. La Ley 99 fue innovadora al combinar regulación directa con instrumentos económicos, permitiendo que quienes contaminan paguen por el daño causado. Las tasas retributivas se aplicaban a descargas de residuos líquidos, y las compensatorias al uso de recursos renovables.",
    icono: "🏛️",
    iconoGrande: "🌎📊",
    color: "#fed7aa",
