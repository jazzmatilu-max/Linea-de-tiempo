    ...
    <div style={{
      ...
      <div style={{
        ...
        <p style={{ fontSize: '11px', color: '#64748b', marginTop: '8px', fontWeight: '700' }}>
          💡 Haz clic en cualquier tarjeta de hito para ver su contenido completo y sus citas bibliográficas formales.
        </p>
      </div>
                  ...
                  {isLeft ? (
                    ...
                    >
                      ...
                      <div style={{ padding: '14px' }}>
                        ...
                        <span style={{ display: 'block', marginTop: '6px', fontSize: '9px', fontWeight: 'bold', color: '#2563eb' }}>
                          + Ver cita y ampliar
                        </span>
                      </div>
                    </div>
      ...
      {/* MODAL INTERACTIVO PARA CITAS Y DETALLE */}
      {selectedHito && (
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ padding: '20px' }}>
              ...
              <h3 style={{ fontSize: '12px', fontWeight: '900', color: '#1e293b', margin: '0 0 10px 0' }}>
                {selectedHito.subtitulo}
              </h3>
              <p style={{ fontSize: '11px', color: '#334155', lineHeight: '1.5', margin: '0 0 16px 0', backgroundColor: '#f8fafc', padding: '10px', borderRadius: '6px', border: '1px solid #cbd5e1' }}>
              ...
              <div style={{ borderTop: '2px dashed #cbd5e1', paddingTop: '12px' }}>
                <span style={{ fontSize: '10px', fontWeight: '900', textTransform: 'uppercase', color: '#1e293b', display: 'block', marginBottom: '4px' }}>
                  📖 Cita / Referencia Académica:
                </span>
                <p style={{ fontSize: '10px', color: '#475569', fontStyle: 'italic', margin: 0, backgroundColor: '#fef3c7', padding: '8px', borderRadius: '6px', border: '1px solid #f59e0b' }}>
                  {selectedHito.fuente}
                </p>
              </div>
